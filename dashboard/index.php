...
<div class="dashboard-container">
    ...
    <div class="menu-section">
        ...
        <div id="bookings-section" class="menu-content">
            <a href="<?= BASE_URL ?>/modules/Bookings/" class="dashboard-button db-booking">View Bookings</a>
            <a href="<?= BASE_URL ?>/modules/Bookings/add.php" class="dashboard-button db-view">Add Booking</a>
            <a href="<?= BASE_URL ?>/modules/Bookings/reports.php" class="dashboard-button db-reports">Booking Reports</a>
        </div>
    </div>
    ...
    <div class="menu-section">
        ...
        <div id="prebookings-section" class="menu-content">
            <a href="<?= BASE_URL ?>/modules/Prebookings/add.php" class="dashboard-button db-booking">Add Prebooking</a>
            <a href="<?= BASE_URL ?>/modules/Prebookings/" class="dashboard-button db-view">View Prebookings</a>
        </div>
    </div>
    ...
    <div class="menu-section">
        ...
        <div id="clients-section" class="menu-content">
            <a href="<?= BASE_URL ?>/modules/Clients/" class="dashboard-button db-clients">View Clients</a>
            <a href="<?= BASE_URL ?>/modules/Clients/add.php" class="dashboard-button db-contact">Add Client</a>
            <a href="<?= BASE_URL ?>/modules/Clients/duplicates/" class="dashboard-button db-groups">Manage Duplicates</a>
        </div>
    </div>
    ...
    <div class="menu-section">
        ...
        <div id="fuel-section" class="menu-content">
            <a href="<?= BASE_URL ?>/modules/Fuel/add.php" class="dashboard-button db-fuel">Log Fuel</a>
            <a href="<?= BASE_URL ?>/modules/Fuel/" class="dashboard-button db-fuel-reports">Fuel Reports</a>
        </div>
    </div>
