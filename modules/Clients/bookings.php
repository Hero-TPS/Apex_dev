<?php
// modules/Clients/bookings.php
$page_title = 'Client Bookings';
$page_subtitle = 'Booking History';
$show_breadcrumb = true;
$breadcrumb = ' > <a href="' . (defined('BASE_URL') ? BASE_URL : '') . '/modules/Clients/">Clients</a> > Booking History';
...
<a href="<?= BASE_URL ?>/modules/Clients/?highlight=<?= (int) $contactId ?>" class="page-action-btn back">⬅️ Back</a>
