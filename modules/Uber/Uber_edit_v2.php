...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            const r = res.record;
            window.carRentalPrice = r.ledger.car_rental;
            balanceBefore = r.ledger.balance_before;
            ...
            $('#edit-form-container').html(`
                <form id="edit-uber-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="metric-row"><span>Outstanding Balance (before this week)</span><strong>R <span id="shortfallBalanceBefore">${balanceBefore.toFixed(2)}</span></strong></div>
                        <p class="at-help-text">Recalculated live from full history — editing an earlier week updates every balance after it.</p>

                        <div class="metric-row"><span>Card Income (Total Income − Cash)</span><span>R <span id="shortfallCardIncome">0.00</span></span></div>
                        <div class="metric-row"><span>Car Rental (weekly)</span><span>R <span id="shortfallCarRental">${r.ledger.car_rental.toFixed(2)}</span></span></div>
